...
export const AddProperty: React.FC = () => {
    ...
    const [visibleProperties, setVisibleProperties] = useState(3); // Number of properties to show initially
        ...
        <div className="container mx-auto px-6 py-12">
                ...
                {userProperties.length === 0 ? (
                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {userProperties.slice(0, visibleProperties).map((property) => (
                        ...
                        {visibleProperties < userProperties.length && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-8">
                    <h2 className="text-2xl font-bold mb-6">Policies and Rules</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700">
                            <strong>1. Accuracy of Information:</strong> Ensure all property details are accurate and up-to-date. Misleading information may result in penalties.
                        </p>
                        <p className="text-gray-700">
                            <strong>2. Pricing Transparency:</strong> Clearly state the price of the property. Hidden fees are not allowed.
                        </p>
                        <p className="text-gray-700">
                            <strong>3. Image Guidelines:</strong> Upload high-quality images that accurately represent the property. Do not use misleading or edited photos.
                        </p>
                        <p className="text-gray-700">
                            <strong>4. Availability:</strong> Keep the property availability status updated. Overbooking is not permitted.
                        </p>
                        <p className="text-gray-700">
                            <strong>5. Compliance with Laws:</strong> Ensure the property complies with all local laws and regulations.
                        </p>
                        <p className="text-gray-700">
                            <strong>6. Cancellation Policy:</strong> Clearly state the cancellation policy for bookings.
                        </p>
                        <p className="text-gray-700">
                            <strong>7. Safety Standards:</strong> Maintain safety standards and provide necessary amenities for guests.
                        </p>
                        <p className="text-gray-700">
                            <strong>8. Respect for Neighbors:</strong> Ensure guests respect the neighborhood and avoid causing disturbances.
                        </p>
                    </div>
                </div>
            </div>
